...
# Author: Mayuresh Kadu (Dt 12/04/2010)
#
# Assumption: The same set of actions are to be repeated of each host
#
# TODO: display error/info messages using logging functions
...
if [ ! -s $MONITOR_HOSTLIST_FILE -o ! -r $MONITOR_HOSTLIST_FILE -o $nHostListCount -eq 0 ]; then
...
do
  ...
  ## Sample set of actions - replace these with whatever you need done
  #
